...
var image="https://www.citypng.com/public/uploads/small/116657901258e7u6qf8tmkyxkwme3zncnnk09as5nbtrwsbmacl2u2hi4muzeojntjmpgwazjtw33vtglkxkt6v9lh2xvsfagmwijtwmpql3cku.png";  //Image path should be given here
var no = 13; // No of images should fall
...
for (i = 0; i < no; ++ i) {  
	...
	document.write("<div id=\"dot"+ i +"\" style=\"POSITION: absolute; Z-INDEX: "+ i +"; VISIBILITY: visible; TOP: 15px;LEFT: 15px;\"><img src='"+image+"' border=\"0\" width=\"60\" height=\"60\"><\/div>");
}
